    ...
    <div style={{ maxWidth: "700px", margin: "0 auto" }}>
      ...
      <div className="d-flex flex-column gap-3">
        ...
        <div>
          ...
          />
          <small style={{ color: titulo.length >= 45 ? "#EE715F" : "#888" }}>{titulo.length}/50</small>
        </div>
        ...
        <div>
          ...
          />
          <small style={{ color: descricao.length >= 180 ? "#EE715F" : "#888" }}>{descricao.length}/200</small>
        </div>
        ...
        <div>
          ...
          />
          <small style={{ color: orientacoes.length >= 270 ? "#EE715F" : "#888" }}>{orientacoes.length}/300</small>
        </div>
